...
# MAGIC LOCATION '/mnt/formula1dlrjsa/demo'

# COMMAND ----------

results_df = spark.read \
.option("inferSchema", True) \
.json("/mnt/formula1dlrjsa/raw/2021-03-28/results.json")
...
results_df.write.format("delta").mode("overwrite").save("/mnt/formula1dlrjsa/demo/results_external")
...
# MAGIC USING DELTA
# MAGIC LOCATION '/mnt/formula1dlrjsa/demo/results_external'
...
results_external_df = spark.read.format("delta").load("/mnt/formula1dlrjsa/demo/results_external")
